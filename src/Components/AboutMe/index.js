...
function About() {
    ...
    <div className={css.flier}><img alt="avatar made for School of Code" src={Avatar}/></div>
      ...
      <p>I have now come full circle and am volunteering as a remote instructor on the Code First: Girls Introduction to Web Development course. It is so fulfilling to be able to give others the same opportunity that I had. On this course I teach HTML, CSS, JavaScript, project design and management, GitHub and version control. I have received come really complimentary feedback on my teaching and I enjoy it thoroughly!</p>
