...
function About() {
    return ( <div className={css.wrapper}><h2>Launching Into Tech</h2>
      ...
      <img id={css.prof2} className={css.prof1} width="500px" alt="picture of the School of Code Cohort" src="https://media-exp1.licdn.com/dms/image/C5616AQHoNkSuuHxZkA/profile-displaybackgroundimage-shrink_350_1400/0?e=1609372800&v=beta&t=P9ot6Yb2HVT5Li-IUnzN6UqewoY_RfP5w-u6SR_c_14"/>
